google.maps.Polyline.prototype.getBounds=function(){var n=new google.maps.LatLngBounds;return this.getPath().forEach(function(o){n.extend(new google.maps.LatLng(o.lat(),o.lng()))}),n};
function Marker(e){e=_.extend({map:Map.getMap()},e);var a;switch(e.icon){case"lakes":a="mm_20_purple";break;case"monasteries":a="mm_20_yellow";break;case"misc":a="mm_20_blue";break;case"springs":a="mm_20_white";break;case"picnic-areas":a="mm_20_green";break;case"monuments":a="mm_20_red";break;case"fishponds":a="mm_20_black";break;case"waterfalls":a="mm_20_orange";break;case"lookouts":a="mm_20_gray";break;case"meadows":a="mm_20_brown";break;default:a="mm_20_white"}return e.icon="http://maps.gstatic.com/mapfiles/ridefinder-images/"+a+".png",function(){var a=new google.maps.Marker(e);return google.maps.event.addListener(a,"click",function(){Map.showInfoWindow(getInfoWindowContent(e.data),this)}),a}()}function getInfoWindowContent(e){var a="<h1>"+e.title+"</h1>";return e.description&&(a+="<p>"+e.description+"</p>"),e.image&&(a+='<img src="'+e.image+'">'),e.link&&(a+='<a href="'+e.link+'" target="_blank">'+e.link+"</a>"),a}
function Track(e){return e=_.extend({map:Map.getMap(),geodesic:!0,strokeColor:"rgb(51, 102, 204)",strokeOpacity:1,strokeWeight:4},e),function(){return new google.maps.Polyline(e)}()}
function Kml(e,n){return n=_.extend({map:Map.getMap(),preserveViewport:!0,suppressInfoWindows:!0,data:{type:"kml"}},n),function(){return new google.maps.KmlLayer(e,n)}()}
